...
// Get my restaurant (for restaurant owners) — MUST be before /:id to avoid route shadowing
router.get("/my/restaurant", authenticate, requireRestaurantOwnerOrAdmin, RestaurantController.getMyRestaurant);

// Get restaurant by ID (must be after specific routes like /search, /nearby, /my)
